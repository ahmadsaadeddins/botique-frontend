...
import dg1 from "assets/img/R.jpg";
import dg2 from "assets/img/R2.jpg";
import dg3 from "assets/img/R3.jpg";
import dg4 from "assets/Mt_Baker.mp4";
              ...
              <div className={classes.container}>
                <GridContainer>
                  <GridItem xs={12} sm={6} md={6}>
                    <h1 className={classes.title}>Hurghada Egypt Tours</h1>
                    <h4>
